...
public class WeaponGestorController : IComparable<WeaponGestorController>
{
    //
    ...
    public WeaponGestorController(float shootRadiusWpX, float attackCoolDownWpX, GameObject wpX, GameObject bulletWpX, GameObject shootParticleWpX,string specialConditions0X, float speedAttackX)
    {
